...
axes[0].set_title(f"LX ({year_lx}) → SAM ({year_sam})",font = 'serif', fontsize = 18.5)
axes[0].set_xlabel("Fractional Debris Cover Change", font = 'serif', fontsize = 17.5)
axes[0].set_ylabel("Frequency", font = 'serif', fontsize = 17.5)
axes[0].set_ylim(0, 800)
axes[0].set_yticks(range(0, 801, 100))
...
axes[1].set_title(f"SAM ({year_sam}) → S2 ({year_s2})",font = 'serif', fontsize = 18.5)
axes[1].set_xlabel("Fractional Debris Cover Change", font = 'serif', fontsize = 17.5)
axes[1].set_ylim(0, 800)
axes[1].set_yticks(range(0, 801, 100))
...
axes[2].set_title(f"LX ({year_lx}) → S2 ({year_s2})", font = 'serif',fontsize = 18.5)
axes[2].set_xlabel("Fractional Debris Cover Change", font = 'serif', fontsize = 17.5)
axes[2].set_ylim(0, 800)
axes[2].set_yticks(range(0, 801, 100))
