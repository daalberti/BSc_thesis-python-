...
#what this code does:
#   - loop through RGI 7.0 regions 01, 10, 11, 12, 14, 15, 18
#   - reads DEM files in region-specific directory, merges and reprojects DEM's to region-specific EPSG
#   - creates directory for each region and saves final, merged and reprojected DEM.
...
for region in regions:
    ...
    #Replace 0 with NaN and save to _masked
    ...
    # Reproject masked files to region-specific CRS
    ...
    #Build VRT from reprojected files
    input_files = [
