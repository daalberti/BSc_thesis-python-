...
plt.xlabel("Pixel Ratio", fontsize = 16.5, font = 'serif')
plt.ylabel("Relative Elevation", fontsize = 16.5, font = 'serif')
...
plt.xlabel("Mean Pixel Ratio", fontsize = 16.5, font = 'serif')
...
plt.xlabel("Weighted Mean Pixel Ratio", fontsize = 16.5, font = 'serif')
#plt.ylabel("Relative Elevation (0-1)", fontsize = 16.5)
...
plt.xlabel('Max difference band per glacier', fontsize = 18, font = 'serif')
plt.ylabel('Number of glaciers', fontsize = 18, font = 'serif')
