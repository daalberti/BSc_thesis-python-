...
# what this code does:
# - extracts only the relevant (i.e. matching glacier entries across datasets) in the SGI and SAM glacier outline dataset using previously created sgi and sam (debris) -matched files
# - duplicates are handled according to "5_clip_match_merge_handleduplicates.py"
