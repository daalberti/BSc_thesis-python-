...
for src, grp in df_for_plots.groupby('source'):
    ...
    if src=='s2':
        ...
        plt.plot(shifted, rel_elevs, linestyle='--',
                 ...
                 color=colors[src])
plt.xlabel("Mean Pixel Ratio", font = 'serif', fontsize = 17)
plt.ylabel("Relative Elevation", font = 'serif', fontsize = 17)
...
plt.xlabel("Weighted Mean Pixel Ratio", font = 'serif', fontsize = 16)
...
plt.xlabel('Max difference band per glacier', font = 'serif', fontsize = 17)
plt.ylabel('Number of Glaciers', font = 'serif', fontsize = 17)
